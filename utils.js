        ...
        elItem.innerHTML = `
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <a class="card-link btn btn-success w-100 mx-auto mb-2 btn__more" data-more="${item.id}" >More</a>
    ...
    arr.forEach(item => {
        ...
        elItem.innerHTML = `
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">${item.categories}</li>
                <li class="list-group-item">
                    <a class="card-link btn btn-success w-100 mx-auto mb-2" data-more="${item.id}" >More</a>
                    <a href="${item.link}" class="card-link btn btn-danger w-100 mx-auto mb-2">YouTube</a>
